...
const OrdersStatus = () => {
  ...
  const addCreditPayment = (item) => {
    // const newArrayCredit = [...oldArrayCredit, OrderPrice];
    // const OrderPriceToNumber = parseFloat(OrderPrice) || 0;
    // const OrderPriceToNumber = parseFloat(OrderPrice.replace("AED", "").trim());
    const newArrayCredit = [...(item?.userInfo?.credit || []), item];
    const updatedUser = { credit: newArrayCredit };
    dispatch(updateProfile(item?.userInfo?._id, updatedUser));
    // console.log(profileId, oldArrayCredit, OrderPrice);
  };
                          ...
                          <div className="modal-footer d-flex justify-content-between">
                            ...
                            <button
                              ...
                              onClick={() => {
                                ...
                                setOpenPaymentId(null);
                                // dispatch(
                                //   updateProfile(item?.userInfo?._id, {credit: userInfo.credit})
                                // );
                                addCreditPayment(
                                  item
                                  // item?.userInfo?._id,
                                  // item?.userInfo?.credit,
                                  // item?.totalPrice
                                );
                              }}
                            >
